...
BASE_URL = "https://www.caprabo.com"
OUTPUT_HTML = "caprabo_debug.html"
OUTPUT_PNG = "caprabo_debug.png"

def extract_caprabo_products(page):
    """Extract products from Caprabo category page"""
    try:
...
def scrape_caprabo():
    print("START Starting Caprabo scraper...")
    with sync_playwright() as p:
        ...
        try:
            print("GLOBE Visiting Caprabo homepage...")
            ...
            for category in categories_to_try:
                ...
                try:
                    ...
                    category_products = extract_caprabo_products(page)
            ...
            for i, product in enumerate(all_products, 1):
                try:
                    existing_product = get_product_by_name_and_store(product["name"], "caprabo")
                    if existing_product:
                        ...
                        insert_product(product["name"], product["price"], product["category"], "caprabo", product["quantity"])
